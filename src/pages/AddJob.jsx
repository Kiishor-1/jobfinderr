...
import { createJob } from '../slices/jobSlice'; // Update with your actual slice path
...
export default function AddJob() {
    ...
    const [currentSkill, setCurrentSkill] = useState(""); // State for current skill input
    const [responsibilities, setResponsibilities] = useState([]); // State for responsibilities
    const [currentResponsibility, setCurrentResponsibility] = useState(""); // State for current responsibility input
    ...
    const initialFields = {
        ...
        aboutJob: {
            description: "", // Add aboutJob description field
            responsibility: [] // Add responsibilities as an array
        }
    };
    ...
    const onSubmit = (data) => {
        const formData = {
            ...
            skills: skills, // Include skills in the formData
            duration: Number(data.duration), // Ensure duration is a number
            aboutJob: {
                description: data.aboutJob.description, // About job description
    ...
    const handleAddSkill = () => { // New handler for adding skills
    ...
    const handleRemoveSkill = (skillToRemove) => { // New handler for removing skills
...
//     const [currentSkill, setCurrentSkill] = useState(""); // State for current input value
//     const [responsibilities, setResponsibilities] = useState([]); // State for responsibilities
//     const [currentResponsibility, setCurrentResponsibility] = useState(""); // State for current responsibility input
